...
################################################################################:
                  ...
                  # IMPORTANT #
# THE RESULTS OF THE ANALYSIS PRESENTED IN THE THESIS WERE DONE
# UNSEEDED (and I didn't notice until too late)
  # results differ mostly in the SIMPER analysis:
    # MCP has 1 less difference
    # PAP has 1 less difference
    # BBR has 3 less differences
    # CRM has 1 less difference
    
    # A. floribunda contributes to 1 more difference
    # E. pilularis contributes to 1 more difference
    # Redgums contribute to 4 less differences
